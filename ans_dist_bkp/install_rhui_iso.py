...
p1_file = key_nam + ".pem"
file_list = ['rhui20/extract_conf.sh','rhui20/rhui20-iso.tar', 'rhui20/answers_file', 'rhui20/gen_certs.tar', 'rhui20/run_distribute.sh', 'rhui20/host.sh', 'rhui20/hostname.sh']
...
for instance in reservation_rhua.instances:
    host_pulp_srv = instance.private_dns_name
    stext = "localhost"
    dtext = host_pulp_srv
    file_list_file = ['pulp.conf', 'cds.conf']
