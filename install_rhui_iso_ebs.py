...
import time
import os
import boto.ec2.blockdevicemapping import EBSBlockDeviceType, BlockDeviceMapping
...
reservation_rhua = im_rhua.run(min_count='1', max_count='1', key_name=key_nam, placement=reg_name, security_groups=['RHUA Security Group'], instance_type='m1.large', block_device_map=map)
reservation_cds = im_cds.run(min_count='2', max_count='2', key_name=key_nam, placement=reg_name, security_groups=['CDS Security Group'], instance_type='m1.large', block_device_map=map)
reservation_client = im_client.run(min_count='1', max_count='1', key_name=key_nam, placement=reg_name, security_groups=['Client Security Group'], instance_type='m1.large', block_device_map=map)
